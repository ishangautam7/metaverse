  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-white shadow-lg rounded-full px-6 py-2 flex gap-4 items-center z-50 border border-gray-200">
      ...
      <button
        ...
        className={`p-2 rounded-full transition-colors ${isCameraOn ? 'bg-green-100 hover:bg-green-200' : 'bg-red-100 hover:bg-red-200'}`}
      >
      ...
      <button
        ...
        className={`p-2 rounded-full transition-colors ${isMicOn ? 'bg-green-100 hover:bg-green-200' : 'bg-red-100 hover:bg-red-200'}`}
      >
      ...
      <button
        ...
        className={`p-2 rounded-full ${isScreenSharing ? 'bg-yellow-100 hover:bg-yellow-200' : 'bg-blue-100 hover:bg-blue-200'} transition-colors`}
      >
